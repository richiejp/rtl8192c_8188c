...
enum station_info_flags {
	STATION_INFO_SIGNAL = BIT(NL80211_STA_INFO_SIGNAL),
	STATION_INFO_TX_BITRATE = BIT(NL80211_STA_INFO_TX_BITRATE),
	STATION_INFO_RX_PACKETS = BIT(NL80211_STA_INFO_RX_PACKETS),
	STATION_INFO_TX_PACKETS = BIT(NL80211_STA_INFO_TX_PACKETS)
};
#endif
